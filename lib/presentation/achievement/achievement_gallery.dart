...
class _AchievementGalleryState extends State<AchievementGallery>
  ...
  final List<Map<String, dynamic>> _allAchievements = [
    ...
    },
    {
      'id': 11,
      'title': 'Early Bird',
      'description': 'Complete 1,000 steps before 7 AM. Rise and shine!',
      'category': 'Steps',
      'rarity': 'rare',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Walk 1,000 steps before 7 AM',
      'points': 350,
    },
    {
      'id': 12,
      'title': 'Weekend Warrior',
      'description': 'Hit 20,000 steps on a Saturday or Sunday. No rest for legends!',
      'category': 'Steps',
      'rarity': 'epic',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Walk 20,000 steps on a weekend day',
      'points': 800,
    },
    {
      'id': 13,
      'title': '7-Day Streak',
      'description': 'Walk at least 5,000 steps every day for a full week.',
      'category': 'Streak',
      'rarity': 'rare',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Complete a 7-day streak of 5K steps',
      'points': 600,
    },
    {
      'id': 14,
      'title': 'Iron Feet',
      'description': 'Walk 10,000 steps every day for 30 days straight. Absolute dedication!',
      'category': 'Streak',
      'rarity': 'legendary',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Complete a 30-day streak of 10K steps',
      'points': 3000,
    },
    {
      'id': 15,
      'title': 'Speed Demon',
      'description': 'Walk 5,000 steps in under 1 hour. Fast feet!',
      'category': 'Challenge',
      'rarity': 'epic',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Walk 5,000 steps in under 1 hour',
      'points': 750,
    },
    {
      'id': 16,
      'title': 'Social Butterfly',
      'description': 'Add 10 friends and complete a challenge with each. Networking champion!',
      'category': 'Social',
      'rarity': 'epic',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Complete challenges with 10 friends',
      'points': 1500,
    },
    {
      'id': 17,
      'title': 'Double Trouble',
      'description': 'Hit your daily goal twice in one day. Overachiever status!',
      'category': 'Steps',
      'rarity': 'rare',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Reach 2x your daily step goal in one day',
      'points': 500,
    },
    {
      'id': 18,
      'title': 'Around the World',
      'description': 'Walk the equivalent of the Earth\'s circumference: 24,901 miles!',
      'category': 'Miles',
      'rarity': 'legendary',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Walk 24,901 total miles',
      'points': 10000,
    },
    {
      'id': 19,
      'title': 'Night Walker',
      'description': 'Walk 3,000 steps between 10 PM and midnight. The city is yours!',
      'category': 'Challenge',
      'rarity': 'rare',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Walk 3,000 steps between 10 PM - midnight',
      'points': 400,
    },
    {
      'id': 20,
      'title': 'Leaderboard Legend',
      'description': 'Reach #1 on the global leaderboard. You\'re the best of the best!',
      'category': 'Competitive',
      'rarity': 'legendary',
      'isEarned': false,
      'progress': 0.0,
      'requirement': 'Reach rank #1 on global leaderboard',
      'points': 5000,
    },
  ];
